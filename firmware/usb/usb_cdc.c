...
ErrorCode_t VCOM_SendBreak (USBD_HANDLE_T hCDC __attribute__((unused)), uint16_t mstime)
{
	VCOM_DATA_T* pVcom = &g_vCOM;
...
ErrorCode_t VCOM_bulk_in_hdlr(USBD_HANDLE_T hUsb __attribute__((unused)), void* data __attribute__((unused)), uint32_t event __attribute__((unused))) 
{
